            ...
            while True:
                ...
                try:
                    ...
                    if len(self.lmList) != 0:
                        ...
                        rightHandAngle = int(np.interp(rightArmAngle, (40, 173), (100, 0)))

                        # Left Arm
                        leftArmAngle = self.findAngle(image, 11, 13, 15)
                        leftHandAngle = int(np.interp(leftArmAngle, (-30, 180), (100, 0)))
                        ...
                        cv2.putText(image,'R', (24, 195), cv2.FONT_HERSHEY_DUPLEX, 1, (0, 0, 255), 7)
                        cv2.rectangle(image,(8,200),(50,400),(0,255,0),5)
                        cv2.rectangle(image, (8, int(rightval)), (50, 400), (0,255, 0), -1)

                        cv2.putText(image, 'L', (962, 195), cv2.FONT_HERSHEY_DUPLEX, 1, (0, 0, 255), 7)
